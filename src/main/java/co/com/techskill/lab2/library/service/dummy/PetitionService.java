...
public class PetitionService {
    ...
    public PetitionService(){
        petitions.add(new PetitionDTO("09c09cc8-b", "LEND", 5, "6600ab76-3", LocalDate.parse("2025-08-10")));
        petitions.add(new PetitionDTO("2f5fca21-b", "RETURN", 7, "12a13228-0", LocalDate.parse("2025-08-29")));
        ...
        petitions.add(new PetitionDTO("ad4801f0-9", "RETURN", 5, "51ed516f-a", LocalDate.parse("2025-08-15")));
        petitions.add(new PetitionDTO("9cc825c1-7", "RETURN", 7, "12a13228-0", LocalDate.parse("2025-08-21")));
        petitions.add(new PetitionDTO("d5120259-4", "LEND", 4, "11b553eb-b", LocalDate.parse("2025-07-25")));
        petitions.add(new PetitionDTO("09ef7d35-d", "RETURN", 4, "297c17d8-4", LocalDate.parse("2025-08-27")));
        petitions.add(new PetitionDTO("0e6a31b1-f", "RETURN", 4, "6600ab76-3", LocalDate.parse("2025-08-21")));
        ...
        petitions.add(new PetitionDTO("2a6214f1-c", "RETURN", 3, "eb25c2d4-7", LocalDate.parse("2025-08-15")));
        petitions.add(new PetitionDTO("8595a9b7-7", "RETURN", 7, "51ed516f-a", LocalDate.parse("2025-08-21")));
        ...
        petitions.add(new PetitionDTO("cbfdd0aa-c", "RETURN", 7, "1940136a-2", LocalDate.parse("2025-08-21")));
        petitions.add(new PetitionDTO("0ff09c9e-5", "LEND", 6, "11b553eb-b", LocalDate.parse("2025-07-25")));
        petitions.add(new PetitionDTO("86084e60-e", "RETURN", 7, "11b553eb-b", LocalDate.parse("2025-08-21")));
    ...
    //TO - DO: Challenge #2
    public Mono<String> processPetition(String id) {
        LocalDate today = LocalDate.now();
        return dummyFindById(id)
                .switchIfEmpty(Mono.error(new RuntimeException("Petition not found")))
                .filter(petition -> petition.getType() == "RETURN")
                .flatMap(petition -> {
                            long daysBetween = ChronoUnit.DAYS.between(today, petition.getSentAt());
                            if (Math.random() <= 0.4) {
                                return Mono.error(new RuntimeException("Intermitence failure"));
                            } else if(Math.abs(daysBetween) > 3){
                                return Mono.error(new RuntimeException("The petition exceeds 3 days"));
                            }
